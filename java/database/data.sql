...
INSERT INTO users (username,password_hash, email_address,role, membership_tier) VALUES ('user','$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC', 'mockemail','ROLE_USER', 'basic');
INSERT INTO users (username,password_hash, email_address,role, membership_tier) VALUES ('admin','$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC','mockemail2','ROLE_ADMIN', 'premium');
...
VALUES
  ...
  INSERT INTO collections (user_Id, collection_cover, collection_name, is_public)
  VALUES
  (3, 'https://www.albumartexchange.com/coverart/gallery/ja/jackharlowfeaturingd_whatspoppin_ddo5.jpg', 'mock', true);
