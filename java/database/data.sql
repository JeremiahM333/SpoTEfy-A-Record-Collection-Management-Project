...
INSERT INTO users (display_name, password_hash, email_address, role, membership_tier) VALUES ('user', '$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC', 'useremail', 'ROLE_USER', 'standard_mem');
INSERT INTO users (display_name, password_hash, email_address, role, membership_tier) VALUES ('admin', '$2a$08$UkVvwpULis18S19S5pZFn.YHPZt3oaqHZnDwqbCW9pft6uFtkXKDC', 'adminemail', 'ROLE_ADMIN', 'premium_mem');
